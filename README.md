...
website [songfacts.com](https://www.songfacts.com/), which has a database of every song released sorted by year. So now we
...
Spotify API, given a song and the associated artist, can provide a wide range of attributes about the song itself. For the
purposes of this project, we are concerned with the following attributes: duration, acousticness,
...
information can be found [here.](https://developer.spotify.com/documentation/web-api/reference/tracks/get-audio-features/)
...
- Learned how to use the Spotify API to write a Python script to connect the Spotify API with Kenneth's web scraping code
...
- Wrote a Python script to web scrape songs for the dataset and gathered the dataset in the process
...
- Contributed to the implementation of the website
